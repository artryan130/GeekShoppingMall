...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartVO> FindCartByUserId(string userId)
        {
            ...
            cart.CartDetails = await _context.CartDetails.Where(c => c.CartHeaderId == cart.CartHeader.Id).Include(c => c.Product).ToListAsync();
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO vo)
        {
            ...
            {
                var cartDetail = await _context.CartDetails.AsNoTracking().FirstOrDefaultAsync(p => p.ProductId == cart.CartDetails.FirstOrDefault().ProductId && p.CartHeader.Id == cart.CartHeader.Id);
                if (cartDetail == null)
                {
